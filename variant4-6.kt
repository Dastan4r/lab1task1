...
fun firstVar4Function () {
    ...
    if(line != null) {
        try {
            ...
            var topFraction = ln(abs(5*z.toDouble())) + atan(3.0).pow(2);
            var bottomFraction = (3*(z+1).toDouble().pow(2)) + (2.1 * 10.toDouble().pow(-6));
